...
public class CoreIT {
    ...
    public void testFiltersByFilterId() throws Exception {
        ...
        // eth_newFilter
        com.venachain.protocol.core.methods.response.EthFilter ethNewFilter = web3j.ethNewFilter(ethFilter).send();
    ...
    public void testEthNewBlockFilter() throws Exception {
        com.venachain.protocol.core.methods.response.EthFilter ethNewBlockFilter = web3j.ethNewBlockFilter().send();
        assertNotNull(ethNewBlockFilter.getFilterId());
    }

    @Test
    public void testEthNewPendingTransactionFilter() throws Exception {
        com.venachain.protocol.core.methods.response.EthFilter ethNewPendingTransactionFilter =

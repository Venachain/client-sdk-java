...
public class Arrays extends Contract {
    ...
    public RemoteCall<List> multiDynamic(List<List<BigInteger>> input) {
        final Function function = new Function(FUNC_MULTIDYNAMIC, 
                java.util.Arrays.<Type>asList(new com.venachain.abi.datatypes.DynamicArray(
                        com.venachain.abi.Utils.typeMap(input, com.venachain.abi.datatypes.generated.StaticArray2.class, com.venachain.abi.datatypes.generated.Uint256.class))),
    ...
    public RemoteCall<List> multiFixed(List<List<BigInteger>> input) {
        final Function function = new Function(FUNC_MULTIFIXED, 
                java.util.Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.StaticArray6(
                        com.venachain.abi.Utils.typeMap(input, com.venachain.abi.datatypes.generated.StaticArray2.class, com.venachain.abi.datatypes.generated.Uint256.class))),
                java.util.Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Uint256>>() {}));
        return new RemoteCall<List>(
                new Callable<List>() {
    ...
    public RemoteCall<List> fixedReverse(List<BigInteger> input) {
        final Function function = new Function(FUNC_FIXEDREVERSE, 
                java.util.Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.StaticArray10<com.venachain.abi.datatypes.generated.Uint256>(
                        com.venachain.abi.Utils.typeMap(input, com.venachain.abi.datatypes.generated.Uint256.class))),
    ...
    public RemoteCall<List> dynamicReverse(List<BigInteger> input) {
        final Function function = new Function(FUNC_DYNAMICREVERSE, 
                java.util.Arrays.<Type>asList(new com.venachain.abi.datatypes.DynamicArray<com.venachain.abi.datatypes.generated.Uint256>(
                        com.venachain.abi.Utils.typeMap(input, com.venachain.abi.datatypes.generated.Uint256.class))),
                java.util.Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Uint256>>() {}));
        return new RemoteCall<List>(
                new Callable<List>() {

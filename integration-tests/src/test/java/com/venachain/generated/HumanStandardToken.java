package com.venachain.generated;
...
import com.venachain.abi.datatypes.generated.Uint8;
...
public class HumanStandardToken extends Contract {
    ...
    public RemoteCall<TransactionReceipt> approve(String _spender, BigInteger _value) {
        final Function function = new Function(
                FUNC_APPROVE, 
                Arrays.<Type>asList(new com.venachain.abi.datatypes.Address(_spender),
                new com.venachain.abi.datatypes.generated.Uint256(_value)),
    ...
    public RemoteCall<TransactionReceipt> transferFrom(String _from, String _to, BigInteger _value) {
        final Function function = new Function(
                FUNC_TRANSFERFROM, 
                Arrays.<Type>asList(new com.venachain.abi.datatypes.Address(_from),
                new com.venachain.abi.datatypes.Address(_to),
                new com.venachain.abi.datatypes.generated.Uint256(_value)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<BigInteger> balanceOf(String _owner) {
        final Function function = new Function(FUNC_BALANCEOF, 
                Arrays.<Type>asList(new com.venachain.abi.datatypes.Address(_owner)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteCall<TransactionReceipt> transfer(String _to, BigInteger _value) {
        final Function function = new Function(
                FUNC_TRANSFER, 
                Arrays.<Type>asList(new com.venachain.abi.datatypes.Address(_to),
                new com.venachain.abi.datatypes.generated.Uint256(_value)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> approveAndCall(String _spender, BigInteger _value, byte[] _extraData) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new com.venachain.abi.datatypes.Address(_spender),
                new com.venachain.abi.datatypes.generated.Uint256(_value),
                new com.venachain.abi.datatypes.DynamicBytes(_extraData)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<BigInteger> allowance(String _owner, String _spender) {
        final Function function = new Function(FUNC_ALLOWANCE, 
                Arrays.<Type>asList(new com.venachain.abi.datatypes.Address(_owner),
                new com.venachain.abi.datatypes.Address(_spender)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public static RemoteCall<HumanStandardToken> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Uint256(_initialAmount),
                new com.venachain.abi.datatypes.Utf8String(_tokenName),
                new com.venachain.abi.datatypes.generated.Uint8(_decimalUnits),
                new com.venachain.abi.datatypes.Utf8String(_tokenSymbol)));

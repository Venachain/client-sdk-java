...
import com.venachain.abi.datatypes.generated.Uint160;
import com.venachain.abi.datatypes.Address;
import com.venachain.abi.datatypes.Array;
import com.venachain.abi.datatypes.Bool;
import com.venachain.abi.datatypes.Bytes;
...
import com.venachain.abi.datatypes.FixedPointType;
import com.venachain.abi.datatypes.Int;
import com.venachain.abi.datatypes.IntType;
import com.venachain.abi.datatypes.NumericType;
    ...
    static <T extends NumericType> T decodeNumeric(String input, Class<T> type) {
        try {
            ...
            if (Int.class.isAssignableFrom(type) || Fixed.class.isAssignableFrom(type)) {
                resultByteArray[0] = inputByteArray[Type.MAX_BYTE_LENGTH - typeLengthAsBytes];  // take MSB as sign bit
            }

            if (typeLengthAsBytes == inputByteArray.length) {
                System.arraycopy(inputByteArray, 0, resultByteArray, 1, typeLengthAsBytes);
            } else {

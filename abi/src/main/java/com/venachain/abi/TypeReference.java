 ...
 * This is so that we can pass around Typed {@link com.venachain.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends com.venachain.abi.datatypes.Type>
    ...
    public static <T extends com.venachain.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.venachain.abi.datatypes.Type>

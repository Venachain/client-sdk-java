...
import static com.venachain.codegen.SolidityFunctionWrapperGenerator.JAVA_TYPES_ARG;
import static com.venachain.codegen.SolidityFunctionWrapperGenerator.SOLIDITY_TYPES_ARG;
import static com.venachain.codegen.SolidityFunctionWrapperGenerator.getFileNameNoExtension;
...
public class SolidityFunctionWrapperGeneratorTest extends TempFileProvider {
    ...
    private void testCodeGenerationJvmTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, "com.venachain.unittests.java", JAVA_TYPES_ARG);
    ...
    private void testCodeGenerationSolidityTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, "com.venachain.unittests.solidity", SOLIDITY_TYPES_ARG);
    }

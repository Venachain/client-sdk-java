...
public class SolidityFunctionWrapperTest extends TempFileProvider {
    ...
    public void testBuildFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public RemoteCall<TransactionReceipt> functionName(java.math.BigInteger param) {\n"
                        + "  final Function function = new Function(\n"
                        + "      FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<Type>asList(new Uint8(param)), \n"
    ...
    public void testBuildPayableFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public RemoteCall<TransactionReceipt> functionName(java.math.BigInteger param, java.math.BigInteger weiValue) {\n"
                        + "  final Function function = new Function(\n"
                        + "      FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<Type>asList(new Uint8(param)), \n"
                        + "      java.util.Collections.<TypeReference<?>>emptyList());\n"
    ...
    public void testBuildFunctionConstantSingleValueReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public RemoteCall<java.math.BigInteger> functionName(java.math.BigInteger param) {\n"
                        + "  final Function function = new Function(FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<Type>asList(new Uint8(param)), \n"
                        + "      java.util.Arrays.<TypeReference<?>>asList(new TypeReference<Int8>() {}));\n"
    ...
    public void testBuildFunctionConstantSingleValueRawListReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public RemoteCall<java.util.List> functionName(java.math.BigInteger param) {\n"
                + "  final Function function = new Function(FUNC_FUNCTIONNAME, \n"
                + "      java.util.Arrays.<Type>asList(new Uint8(param)), \n"
                + "      java.util.Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Address>>() {}));\n"
                + "  return new RemoteCall<java.util.List>(\n"
                + "      new java.util.concurrent.Callable<java.util.List>() {\n"
                + "        @java.lang.Override\n"
                + "        @java.lang.SuppressWarnings(\"unchecked\")\n"
                + "        public java.util.List call() throws java.lang.Exception {\n"
                + "          java.util.List<Type> result = (java.util.List<Type>) executeCallSingleValueReturn(function, java.util.List.class);\n"
    ...
    public void testBuildFunctionConstantMultipleValueReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected = "public RemoteCall<Tuple2<java.math.BigInteger, java.math.BigInteger>> functionName(java.math.BigInteger param1, java.math.BigInteger param2) {\n"
                + "  final Function function = new Function(FUNC_FUNCTIONNAME, \n"
                + "      java.util.Arrays.<Type>asList(new Uint8(param1), \n"
                + "      new Uint32(param2)), \n"
                + "      java.util.Arrays.<TypeReference<?>>asList(new TypeReference<Int8>() {}, new TypeReference<Int32>() {}));\n"
                + "  return new RemoteCall<Tuple2<java.math.BigInteger, java.math.BigInteger>>(\n"
                + "      new java.util.concurrent.Callable<Tuple2<java.math.BigInteger, java.math.BigInteger>>() {\n"
                + "        @java.lang.Override\n"
                + "        public Tuple2<java.math.BigInteger, java.math.BigInteger> call() throws java.lang.Exception {\n"
                + "          java.util.List<Type> results = executeCallMultipleValueReturn(function);\n"
                + "          return new Tuple2<java.math.BigInteger, java.math.BigInteger>(\n"
    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n"
                        ...
                        + "      java.util.Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>(true) {}, new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}, new TypeReference<Uint256>() {}, new TypeReference<Utf8String>() {}));\n  ;\n\n"
                        + "  public java.util.List<TransferEventResponse> getTransferEvents(TransactionReceipt transactionReceipt) {\n"
                        + "    java.util.List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(TRANSFER_EVENT, transactionReceipt);\n"
                        ...
                        + "    return web3j.ethLogObservable(filter).map(new rx.functions.Func1<Log, TransferEventResponse>() {\n"
                        + "      @java.lang.Override\n"
                        ...
                        + "  }\n"
                        + "\n"
                        + "  public rx.Observable<TransferEventResponse> transferEventObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {\n"

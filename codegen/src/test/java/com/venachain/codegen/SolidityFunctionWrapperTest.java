...
import com.venachain.abi.datatypes.generated.Bytes32;
import com.venachain.abi.datatypes.generated.Int256;
import com.venachain.abi.datatypes.generated.StaticArray10;
import com.venachain.abi.datatypes.generated.StaticArray2;
import com.venachain.abi.datatypes.generated.StaticArray3;
...
import static com.venachain.codegen.SolidityFunctionWrapper.buildTypeName;
import static com.venachain.codegen.SolidityFunctionWrapper.createValidParamName;
import static com.venachain.codegen.SolidityFunctionWrapper.getEventNativeType;
import static com.venachain.codegen.SolidityFunctionWrapper.getNativeType;
...
public class SolidityFunctionWrapperTest extends TempFileProvider {
    ...
    public void testBuildFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public com.venachain.protocol.core.RemoteCall<com.venachain.protocol.core.methods.response.TransactionReceipt> functionName(java.math.BigInteger param) {\n"
                        + "  final com.venachain.abi.datatypes.Function function = new com.venachain.abi.datatypes.Function(\n"
                        + "      FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<com.venachain.abi.datatypes.Type>asList(new com.venachain.abi.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Collections.<com.venachain.abi.TypeReference<?>>emptyList());\n"
    ...
    public void testBuildPayableFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public com.venachain.protocol.core.RemoteCall<com.venachain.protocol.core.methods.response.TransactionReceipt> functionName(java.math.BigInteger param, java.math.BigInteger weiValue) {\n"
                        + "  final com.venachain.abi.datatypes.Function function = new com.venachain.abi.datatypes.Function(\n"
                        + "      FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<com.venachain.abi.datatypes.Type>asList(new com.venachain.abi.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Collections.<com.venachain.abi.TypeReference<?>>emptyList());\n"
    ...
    public void testBuildFunctionConstantSingleValueReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public com.venachain.protocol.core.RemoteCall<java.math.BigInteger> functionName(java.math.BigInteger param) {\n"
                        + "  final com.venachain.abi.datatypes.Function function = new com.venachain.abi.datatypes.Function(FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<com.venachain.abi.datatypes.Type>asList(new com.venachain.abi.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Arrays.<com.venachain.abi.TypeReference<?>>asList(new com.venachain.abi.TypeReference<com.venachain.abi.datatypes.generated.Int8>() {}));\n"
    ...
    public void testBuildFunctionConstantSingleValueRawListReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public com.venachain.protocol.core.RemoteCall<java.util.List> functionName(java.math.BigInteger param) {\n"
                + "  final com.venachain.abi.datatypes.Function function = new com.venachain.abi.datatypes.Function(FUNC_FUNCTIONNAME, \n"
                + "      java.util.Arrays.<com.venachain.abi.datatypes.Type>asList(new com.venachain.abi.datatypes.generated.Uint8(param)), \n"
                + "      java.util.Arrays.<com.venachain.abi.TypeReference<?>>asList(new com.venachain.abi.TypeReference<com.venachain.abi.datatypes.DynamicArray<com.venachain.abi.datatypes.Address>>() {}));\n"
                + "  return new com.venachain.protocol.core.RemoteCall<java.util.List>(\n"
                + "      new java.util.concurrent.Callable<java.util.List>() {\n"
                + "        @java.lang.Override\n"
                + "        @java.lang.SuppressWarnings(\"unchecked\")\n"
                + "        public java.util.List call() throws java.lang.Exception {\n"
                + "          java.util.List<com.venachain.abi.datatypes.Type> result = (java.util.List<com.venachain.abi.datatypes.Type>) executeCallSingleValueReturn(function, java.util.List.class);\n"
    ...
    public void testBuildFunctionConstantMultipleValueReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected = "public com.venachain.protocol.core.RemoteCall<com.venachain.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>> functionName(java.math.BigInteger param1, java.math.BigInteger param2) {\n"
                + "  final com.venachain.abi.datatypes.Function function = new com.venachain.abi.datatypes.Function(FUNC_FUNCTIONNAME, \n"
                + "      java.util.Arrays.<com.venachain.abi.datatypes.Type>asList(new com.venachain.abi.datatypes.generated.Uint8(param1), \n"
                + "      new com.venachain.abi.datatypes.generated.Uint32(param2)), \n"
                + "      java.util.Arrays.<com.venachain.abi.TypeReference<?>>asList(new com.venachain.abi.TypeReference<com.venachain.abi.datatypes.generated.Int8>() {}, new com.venachain.abi.TypeReference<com.venachain.abi.datatypes.generated.Int32>() {}));\n"
                + "  return new com.venachain.protocol.core.RemoteCall<com.venachain.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>>(\n"
                + "      new java.util.concurrent.Callable<com.venachain.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>>() {\n"
                + "        @java.lang.Override\n"
                + "        public com.venachain.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger> call() throws java.lang.Exception {\n"
                + "          java.util.List<com.venachain.abi.datatypes.Type> results = executeCallMultipleValueReturn(function);\n"
                + "          return new com.venachain.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>(\n"
    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n"
                        + "  public static final com.venachain.abi.datatypes.Event TRANSFER_EVENT = new com.venachain.abi.datatypes.Event(\"Transfer\", \n"
                        + "      java.util.Arrays.<com.venachain.abi.TypeReference<?>>asList(new com.venachain.abi.TypeReference<com.venachain.abi.datatypes.Utf8String>(true) {}, new com.venachain.abi.TypeReference<com.venachain.abi.datatypes.Address>(true) {}, new com.venachain.abi.TypeReference<com.venachain.abi.datatypes.Address>(true) {}, new com.venachain.abi.TypeReference<com.venachain.abi.datatypes.generated.Uint256>() {}, new com.venachain.abi.TypeReference<com.venachain.abi.datatypes.Utf8String>() {}));\n  ;\n\n"
                        + "  public java.util.List<TransferEventResponse> getTransferEvents(com.venachain.protocol.core.methods.response.TransactionReceipt transactionReceipt) {\n"
                        + "    java.util.List<com.venachain.tx.Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(TRANSFER_EVENT, transactionReceipt);\n"
                        + "    java.util.ArrayList<TransferEventResponse> responses = new java.util.ArrayList<TransferEventResponse>(valueList.size());\n"
                        + "    for (com.venachain.tx.Contract.EventValuesWithLog eventValues : valueList) {\n"
                        ...
                        + "  }\n"
                        + "\n"
                        + "  public rx.Observable<TransferEventResponse> transferEventObservable(com.venachain.protocol.core.methods.request.EthFilter filter) {\n"
                        + "    return web3j.ethLogObservable(filter).map(new rx.functions.Func1<com.venachain.protocol.core.methods.response.Log, TransferEventResponse>() {\n"
                        + "      @java.lang.Override\n"
                        + "      public TransferEventResponse call(com.venachain.protocol.core.methods.response.Log log) {\n"
                        + "        com.venachain.tx.Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(TRANSFER_EVENT, log);\n"
                        + "        TransferEventResponse typedResponse = new TransferEventResponse();\n"
                        ...
                        + "  }\n"
                        + "\n"
                        + "  public rx.Observable<TransferEventResponse> transferEventObservable(com.venachain.protocol.core.DefaultBlockParameter startBlock, com.venachain.protocol.core.DefaultBlockParameter endBlock) {\n"
                        + "    com.venachain.protocol.core.methods.request.EthFilter filter = new com.venachain.protocol.core.methods.request.EthFilter(startBlock, endBlock, getContractAddress());\n"
                        + "    filter.addSingleTopic(com.venachain.abi.EventEncoder.encode(TRANSFER_EVENT));\n"
                        + "    return transferEventObservable(filter);\n"
                        + "  }\n"
                        + "\n"
                        + "  public static class TransferEventResponse {\n"
                        + "    public com.venachain.protocol.core.methods.response.Log log;\n"
                        + "\n"
                        + "    public byte[] id;\n"
                        + "\n"

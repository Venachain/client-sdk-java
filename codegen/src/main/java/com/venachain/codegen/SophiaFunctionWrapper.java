...
import com.venachain.abi.datatypes.*;
import com.venachain.abi.datatypes.generated.AbiTypes;
...
import com.venachain.protocol.core.methods.response.AbiDefinition.NamedType;
...
public class SophiaFunctionWrapper extends Generator {
    ...
    private void addAddressesSupport(TypeSpec.Builder classBuilder,
        ...
        if (addresses != null) {
            ...
            // See com.venachain.tx.Contract#getStaticDeployedAddress(String)
        ...
        if (parameterSpec.type instanceof ParameterizedTypeName) {
            ...
            if (typeNames.size() != 1) {
                ...
                return "new " + parameterSpecType + "(\n"
                        + "        com.venachain.abi.Utils.typeMap("
    ...
    private void buildConstantFunction(
        ...
        if (outputParameterTypes.isEmpty()) {
            ...
            ParameterizedTypeName parameterizedTupleType = ParameterizedTypeName.get(
                    ClassName.get(
                            "com.venachain.tuples.generated",
    ...
    TypeSpec buildEventResponseObject(
            String className,
            List<com.venachain.codegen.SophiaFunctionWrapper.NamedTypeName> indexedParameters,
            List<com.venachain.codegen.SophiaFunctionWrapper.NamedTypeName> nonIndexedParameters) {

        TypeSpec.Builder builder = TypeSpec.classBuilder(className)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC);

        builder.addField(LOG, "log", Modifier.PUBLIC);
        for (com.venachain.codegen.SophiaFunctionWrapper.NamedTypeName
    ...
    private static Class<?> getStaticArrayTypeReferenceClass(String type) {
        try {
            return Class.forName("com.venachain.abi.datatypes.generated.StaticArray" + type);

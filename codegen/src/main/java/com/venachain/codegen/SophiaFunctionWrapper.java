...
public class SophiaFunctionWrapper extends Generator {
    ...
    String getParameterNames(List<AbiDefinition.NamedType> namedTypes) {
        ...
        return com.venachain.utils.Collection.join(inputParameterNames,", ", parameterName->parameterName);
    }
    ...
    String addParameters(MethodSpec.Builder methodBuilder, List<AbiDefinition.NamedType> namedTypes) {
        ...
        if (useNativeJavaTypes) {
            return com.venachain.utils.Collection.join(
                    inputParameterTypes,
                    ", \n",
    ...
    TypeSpec buildEventResponseObject(
            String className,
            List<SophiaFunctionWrapper.NamedTypeName> indexedParameters,
            List<SophiaFunctionWrapper.NamedTypeName> nonIndexedParameters) {

        TypeSpec.Builder builder = TypeSpec.classBuilder(className)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC);

        builder.addField(LOG, "log", Modifier.PUBLIC);
        for (SophiaFunctionWrapper.NamedTypeName

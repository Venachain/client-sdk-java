...
public class SolidityFunctionWrapper extends Generator {
    ...
    TypeSpec buildEventResponseObject(
            String className,
            List<com.venachain.codegen.SolidityFunctionWrapper.NamedTypeName> indexedParameters,
            List<com.venachain.codegen.SolidityFunctionWrapper.NamedTypeName> nonIndexedParameters) {

        TypeSpec.Builder builder = TypeSpec.classBuilder(className)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC);

        builder.addField(LOG, "log", Modifier.PUBLIC);
        for (com.venachain.codegen.SolidityFunctionWrapper.NamedTypeName

...
import com.venachain.protocol.core.methods.response.VoidResponse;
import com.venachain.protocol.parity.methods.response.FullTraceInfo;
...
import com.venachain.protocol.parity.methods.response.StateDiff;
import com.venachain.protocol.parity.methods.response.Trace;
import com.venachain.protocol.parity.methods.response.VMTrace;
...
public class ResponseTest extends ResponseTester {
    ...
    public void testParityFullTraceResponseTraces() {
        ...
        //CHECKSTYLE:OFF
        com.venachain.protocol.parity.methods.response.Trace trace1 = new com.venachain.protocol.parity.methods.response.Trace();
        ...
        com.venachain.protocol.parity.methods.response.Trace trace2 = new com.venachain.protocol.parity.methods.response.Trace();
        ...
        com.venachain.protocol.parity.methods.response.Trace trace3 = new com.venachain.protocol.parity.methods.response.Trace();
        ...
        com.venachain.protocol.parity.methods.response.Trace trace4 = new com.venachain.protocol.parity.methods.response.Trace();
        ...
        List<com.venachain.protocol.parity.methods.response.Trace> traces = new ArrayList<>();
        traces.add(trace1);
        traces.add(trace2);
        traces.add(trace3);
        traces.add(trace4);

...
public class EnsResolverTest {
    ...
    public void testIsEnsName() {
        assertTrue(EnsResolver.isValidEnsName("eth"));
        assertTrue(EnsResolver.isValidEnsName("web3.eth"));
        assertTrue(EnsResolver.isValidEnsName("0x19e03255f667bdfd50a32722df860b1eeaf4d635.eth"));

        assertFalse(EnsResolver.isValidEnsName("0x19e03255f667bdfd50a32722df860b1eeaf4d635"));
        assertFalse(EnsResolver.isValidEnsName("19e03255f667bdfd50a32722df860b1eeaf4d635"));

        assertTrue(EnsResolver.isValidEnsName(""));
    }
}

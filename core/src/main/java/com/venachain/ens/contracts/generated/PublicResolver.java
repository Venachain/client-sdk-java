package com.venachain.ens.contracts.generated;
...
import com.venachain.tuples.generated.Tuple2;
import com.venachain.tx.Contract;
...
public final class PublicResolver extends Contract {
    ...
    public RemoteCall<Boolean> supportsInterface(byte[] interfaceID) {
        Function function = new Function("supportsInterface", 
                Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Bytes4(interfaceID)),
    ...
    public RemoteCall<TransactionReceipt> setText(byte[] node, String key, String value) {
        Function function = new Function(
                "setText", 
                Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Bytes32(node),
                new com.venachain.abi.datatypes.Utf8String(key),
                new com.venachain.abi.datatypes.Utf8String(value)),
    ...
    public RemoteCall<Tuple2<BigInteger, byte[]>> ABI(byte[] node, BigInteger contentTypes) {
        final Function function = new Function("ABI",
                Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Bytes32(node),
                new com.venachain.abi.datatypes.generated.Uint256(contentTypes)),
    ...
    public RemoteCall<TransactionReceipt> setPubkey(byte[] node, byte[] x, byte[] y) {
        Function function = new Function(
                "setPubkey",
                Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Bytes32(node),
                new com.venachain.abi.datatypes.generated.Bytes32(x),
                new com.venachain.abi.datatypes.generated.Bytes32(y)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setABI(byte[] node, BigInteger contentType, byte[] data) {
        Function function = new Function(
                "setABI",
                Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Bytes32(node),
                new com.venachain.abi.datatypes.generated.Uint256(contentType),
                new com.venachain.abi.datatypes.DynamicBytes(data)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setName(byte[] node, String name) {
        Function function = new Function(
                "setName",
                Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Bytes32(node),
                new com.venachain.abi.datatypes.Utf8String(name)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setContent(byte[] node, byte[] hash) {
        Function function = new Function(
                "setContent",
                Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Bytes32(node),
                new com.venachain.abi.datatypes.generated.Bytes32(hash)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setAddr(byte[] node, String addr) {
        Function function = new Function(
                "setAddr",
                Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Bytes32(node),
                new com.venachain.abi.datatypes.Address(addr)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<PublicResolver> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new com.venachain.abi.datatypes.Address(ensAddr)));

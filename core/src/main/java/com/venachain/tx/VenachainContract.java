...
import com.venachain.abi.VenachainEventEncoder;
...
import com.venachain.protocol.core.*;
...
import com.venachain.tx.exceptions.ContractCallException;
...
public abstract class VenachainContract extends ManagedTransaction {
    ...
    /**
     * @deprecated ...
     * @see com.venachain.tx.gas.DefaultGasProvider
     */
    ...
    private List<Type> executeCall(Function function) throws IOException {
        ...
        if (isCNS){
            ...
            com.venachain.protocol.core.methods.response.EthCall ethCall = web3j.ethCall(

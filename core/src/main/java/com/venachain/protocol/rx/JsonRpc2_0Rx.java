package com.venachain.protocol.rx;
...
import com.venachain.protocol.core.DefaultBlockParameterNumber;
import com.venachain.protocol.core.filters.BlockFilter;
import com.venachain.protocol.core.filters.LogFilter;
import com.venachain.protocol.core.filters.PendingTransactionFilter;
...
import com.venachain.utils.Observables;
...
public class JsonRpc2_0Rx {
    ...
    public Observable<Log> ethLogObservable(
            com.venachain.protocol.core.methods.request.EthFilter ethFilter, long pollingInterval) {
    ...
    private <T> void run(
            com.venachain.protocol.core.filters.Filter<T> filter, Subscriber<? super T> subscriber,

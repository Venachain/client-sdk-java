...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    public Request<?, EthSendTransaction>
            ethSendTransaction(
            com.venachain.protocol.core.methods.request.Transaction transaction) {
        return new Request<>(
                "eth_sendTransaction",
    ...
    public Request<?, EthCall> ethCall(
            com.venachain.protocol.core.methods.request.Transaction transaction, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
                "eth_call",
    ...
    @Override
    public Request<?, EthEstimateGas> ethEstimateGas(com.venachain.protocol.core.methods.request.Transaction transaction) {
        return new Request<>(
                "eth_estimateGas",
                Arrays.asList(transaction),
                web3jService,
    ...
    @Override
    public Request<?, com.venachain.protocol.core.methods.response.ShhPost> shhPost(com.venachain.protocol.core.methods.request.ShhPost shhPost) {
        return new Request<>(
                "shh_post",

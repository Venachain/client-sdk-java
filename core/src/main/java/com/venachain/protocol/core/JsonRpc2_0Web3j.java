...
import com.venachain.protocol.core.methods.response.*;
import rx.Observable;

import com.venachain.protocol.Web3j;
import com.venachain.protocol.Web3jService;
import com.venachain.protocol.core.methods.request.ShhFilter;
import com.venachain.protocol.core.methods.request.ShhPost;
import com.venachain.protocol.core.methods.request.Transaction;
import com.venachain.protocol.rx.JsonRpc2_0Rx;
import com.venachain.protocol.websocket.events.LogNotification;
import com.venachain.protocol.websocket.events.NewHeadsNotification;
...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    @Override
    public Request<?, com.venachain.protocol.core.methods.response.EthSendTransaction>
            ethSendTransaction(
        ...
        return new Request<>(
                ...
                web3jService,
                com.venachain.protocol.core.methods.response.EthSendTransaction.class);
    }
    ...
    @Override
    public Request<?, com.venachain.protocol.core.methods.response.EthCall> ethCall(
            Transaction transaction, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
                "eth_call",
                Arrays.asList(transaction, defaultBlockParameter),
                web3jService,
                com.venachain.protocol.core.methods.response.EthCall.class);
    }
    ...
    @Override
    public Request<?, com.venachain.protocol.core.methods.response.ShhPost> shhPost(ShhPost shhPost) {
        return new Request<>(
                "shh_post",
                Arrays.asList(shhPost),
                web3jService,
                com.venachain.protocol.core.methods.response.ShhPost.class);
    }
    ...
    @Override
    public Observable<com.venachain.protocol.core.methods.response.Transaction>

...
public interface Ethereum {
    ...
    Request<?, com.venachain.protocol.core.methods.response.EthSendTransaction> ethSendTransaction(
            com.venachain.protocol.core.methods.request.Transaction transaction);

    Request<?, com.venachain.protocol.core.methods.response.EthSendTransaction> ethSendRawTransaction(
            String signedTransactionData);

    Request<?, com.venachain.protocol.core.methods.response.EthCall> ethCall(
            com.venachain.protocol.core.methods.request.Transaction transaction,
            DefaultBlockParameter defaultBlockParameter);
    ...
    Request<?, EthFilter> ethNewFilter(com.venachain.protocol.core.methods.request.EthFilter ethFilter);
    ...
    Request<?, EthLog> ethGetLogs(com.venachain.protocol.core.methods.request.EthFilter ethFilter);
    ...
    Request<?, com.venachain.protocol.core.methods.response.ShhPost> shhPost(
            com.venachain.protocol.core.methods.request.ShhPost shhPost);

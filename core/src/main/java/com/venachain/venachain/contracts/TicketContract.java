 ...
 */
public class TicketContract extends VenachainContract {
    ...
    public RemoteCall<TransactionReceipt> VoteTicket(BigInteger count, BigInteger price, String nodeId) {
        final Function function = new Function(
                FUNC_VOTETICKET, 
                Arrays.<Type>asList(new com.venachain.abi.datatypes.generated.Uint64(count), 
                new com.venachain.abi.datatypes.generated.Uint256(price), 
